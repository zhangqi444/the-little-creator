# The Little Creator — Roadmap

## Done

- [x] `what-is-fll.md` — program overview, divisions, Future Edition transition
- [x] `what-is-vex.md` — VEX overview
- [x] `forming-a-team.md` — recruit, structure, set expectations
- [x] `season-planning.md` — month-by-month FLL season timeline
- [x] `core-values-rubric.md` — in-season Core Values rubric for coaches
- [x] `curriculum-starter.md` — 8-week starter curriculum for educators
- [x] `lesson-plan-template.md` — reusable lesson plan template
- [x] `fll-resource-map.md` — curated resource map with annotations
- [x] `learning-materials.md` — learning materials resource page
- [x] `software-tools.md` — software tools resource page
- [x] `robot-programming-basics.md` — SPIKE App block + Python intro, debugging tips (2026-05-16)

## Backlog (next tasks — pick one per heartbeat)

- [x] `drivetrain-basics.md` — building a reliable drive base for VEX IQ / FLL; common mistakes
...
## Wave 6 backlog (new session additions — 2026-05-17)

- [x] `guides/registration-guide.md` — step-by-step national + regional registration
- [x] `guides/registration-reference.md` — verified PDO registration URLs by region
- [x] `guides/division-eligibility.md` — age/grade eligibility for all three divisions
...
- [x] `guides/frc-judging-prep.md` — FRC judging preparation guide completing the judging-prep series for FIRST programs. FRC differs from FLL (three separate rooms) and FTC (single portfolio interview): multiple simultaneous tracks run across the event (pit interviews for all teams, scheduled Impact session for Impact applicants, Engineering Inspiration for invited teams, Rookie All Star pit assessment, GP observation all day, submission-based award reviews). Covers: judging landscape table, pit staffing rules, 2-minute robot overview drill, Impact session structure (20–25 min, student panel + Q&A), what Impact judges probe (measurable outcomes vs one-off events, narrative arc, authentic student ownership), sample probing questions, Engineering Inspiration and Rookie All Star specifics, GP as continuous all-day interview, preparing all team members not just the Impact team, common mistakes table, two-week prep checklist. Wired into sidebar (after FTC Judging Prep), guides/index.md, skill/SKILL.md FRC links. Commit 33e87c4 (2026-06-01 heartbeat 21:58)
