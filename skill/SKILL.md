...
- **FTC** — [What is FTC](/getting-started/what-is-ftc/), [FTC Programming Basics](/guides/ftc-programming-basics/), [FTC Robot Design](/guides/ftc-robot-design/), [FTC Awards](/guides/ftc-awards/), [FTC Engineering Portfolio](/guides/ftc-engineering-portfolio/), [First FTC Tournament](/guides/first-ftc-tournament/)
...
- **VEX U** — [What is VEX U](/getting-started/what-is-vex-u/), [VEX U First Team](/guides/vex-u-first-team/), [VEX U Robot Design](/guides/vex-u-robot-design/)
