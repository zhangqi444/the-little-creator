...
| Division | Ages | What kids do |
|---|---|---|
| **Discover** | 4–6 | Playful first exposure to STEM using LEGO DUPLO bricks. Classroom or at-home activities — no competition. |
| **Explore** | 6–10 | Build a model around a season theme using LEGO bricks plus simple motors and sensors. Show projects at exhibitions, not tournaments. |
| **Challenge** | 9–16 | Build, program, and compete with an autonomous robot using LEGO Education SPIKE Prime. Teams take on a season challenge: robot missions plus an "Innovation Project" they research and present. |

For canonical division descriptions and registration, see the [official FLL site](https://www.firstlegoleague.org). For the global → regional → local handoff, see the [FLL Resource Map](/resources/fll-resource-map/).

## What a FLL Challenge season looks like

Most of this wiki's content is about Challenge. Every Challenge season has three components, all judged at competitions:

**1. Robot Game**
Teams design, build, and program a LEGO Education SPIKE Prime robot to complete missions on a themed game board. Missions are worth different points, and strategy matters as much as engineering.

**2. Innovation Project**
Teams identify a real-world problem related to the season's theme, research it, design a solution, and present it to judges. This is where kids learn to think like scientists and engineers — not just builders.

**3. Core Values**
FLL emphasizes teamwork, discovery, inclusion, and gracious professionalism. Judges evaluate how your team works together, not just what you build.

## The season cycle

- **August** — New season theme and challenge revealed
- **Aug–Nov** — Build season: design, program, iterate
