          ...
          items: [
            { label: 'Overview', link: '/guides/' },
            {
              ...
              items: [
                ...
                { label: 'First Four Weeks', link: '/guides/first-four-weeks/' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Robot Programming Basics', link: '/guides/robot-programming-basics/' },
                { label: 'Python Intermediate', link: '/guides/python-intermediate/' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Engineering Notebook Guide', link: '/guides/notebook-guide/' },
                { label: 'Practice Session Structure', link: '/guides/practice-session-structure/' },
                { label: 'Tournament Day Checklist', link: '/guides/tournament-day-checklist/' },
                { label: 'Tournament Week Prep', link: '/guides/tournament-week-prep/' },
                { label: 'First Tournament Expectations', link: '/guides/first-tournament-expectations/' },
